...
```
video_id + user_id = 16 + 16 = 32 Байт
32 Байт * 150 * 1200 млн = 5364 ГБайт
```
...
596 Байт * 365 * 1200 млн ~ 1853 ГБайт = 237,4 ТБайт 
```

Итоговый размер бд за год
```
308 ГБайт + 5122 ГБайт + 576 ГБайт + 357,6 ГБайт + 5364 ГБайт + 237,4 ТБайт = 2616 ГБайт ~ 248,8 ТБайт
```
...
Nginx                       |16     |16     |           |               |50
Backend                     |16     |32     |           |               |4
PostgreSQL                  |16     |32     |SSD        |8 ТБайт        |10(1 master + 2 slaves)
